...
public class StudentFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(picLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 290, 240, 170));

        iconButton.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        getContentPane().add(iconButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 480, 90, 30));
    ...
    private void iconButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iconButtonActionPerformed
        ...
        File f=fileChooser.getSelectedFile();
         picLabel.setIcon(new ImageIcon(f.toString()));
         fileName=f.getAbsolutePath();
        System.out.print(flieName);
